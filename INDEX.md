...
### <a name="learning-path"></a>**LEARNING-PATH.md** — Curriculum
**Purpose:** Month-by-month learning guide  
...
- Language development contribution

**Best for:** Planning your learning journey, tracking progress

---

## 📖 Grammar Documentation

### <a name="grammar-cv-vc"></a>**05-grammar-cv-vc.md** — Basic Grammar
**Purpose:** Foundation grammar (CV + VC particles)  
...
### <a name="grammar-vcv"></a>**06-basics-vcv.md** — Advanced Grammar
**Purpose:** Expanded VCV particle system  
**Length:** Reference document  
**Contents:**
...
**Best for:** Month 10+, advanced learners, reference

---

## 📚 Vocabulary Documentation

### <a name="lexicon-matrix"></a>**09-lexicon-nominal-matrix.md** — Lexicon System
**Purpose:** Vocabulary organization and modifier system  
**Length:** ~30 minutes study  
**Contents:**
...
**Best for:** Month 3+, understanding system logic, creating words
...
```
Defined (7):  PR /pɾ/  BR /bɾ/  TR /tɾ/  DR /dɾ/  
              KR /kɾ/  GR /gɾ/  PL /pl/
...
- H: Connection/Union
- J̌: Cause/Effect
- Ľ: Certainty/Confidence

**7 EC Modifiers:**
- PR: Manner/Style
- BR: Sensory Quality
- TR: Directionality
- DR: Realness/Concreteness
- KR: Ownership/Control
- GR: Strength/Force
- PL: Intentionality

**All follow a→e→i→o→u progression**

---

## <a name="examples"></a>📝 Example Sentences
...
bi va = he/she does
bo va = we do
bu va = you all/they do
```

**With Tense:**
```
ba va ta = I did (past)
ba va ti = I do (present)
...
## <a name="milestones"></a>🎯 Learning Milestones
...
### **Month 3**
- ✓ 50 words vocabulary
- ✓ Basic CV grammar mastered
- ✓ Can form simple sentences
- ✓ Can ask basic questions

### **Month 6**
- ✓ 100 words vocabulary
- ✓ CV + VC systems understood
- ✓ 5 main modifiers mastered
- ✓ Basic conversational fluency

### **Month 12**
- ✓ 300 words vocabulary
- ✓ All 24 modifiers mastered
- ✓ VCV introduction complete
- ✓ Functional fluency achieved

### **Month 18**
- ✓ 675+ words vocabulary
- ✓ Complete VCV mastery
- ✓ Can create new words systematically
- ✓ Full fluency achieved
...
**Just exploring?**
→ Start with `WELCOME.md` then browse freely
...
1. Read WELCOME.md
2. Skim README.md
3. Start LEARNING-PATH.md Month 1

**Returning student?**
1. Check your current month in LEARNING-PATH.md
2. Review relevant grammar section
