0.6.5
## 🎯 SISTEMA DUAL PARA X, Y, Z

### **Gramática (CV/VC/VCV):**

- X, Y, Z = **Coordenadas espaciais 3D**
- Uso: Partículas gramaticais para posicionamento

### **Léxico Nominal (CVCV words):**

- X = **Causality/Agency** domain
- Y = **Knowledge/Information** domain
- Z = **Intensity/Degree** domain

**Sem conflito:** Contextos diferentes, funções diferentes.

---

## 📜 LISTA OFICIAL DE DOMÍNIOS ONTOLÓGICOS
...
|#|EC|IPA|Domínio|Status|
|---|---|---|---|---|
|21|**PR**|/pɾ/|Process/Method|✅ Definido|
|22|**BR**|/bɾ/|Transport/Vehicle|✅ Definido|
|23|**TR**|/tɾ/|Container/Vessel|✅ Definido|
|24|**DR**|/dɾ/|Creation/Art|✅ Definido|
|25|**KR**|/kɾ/|Growth/Development|✅ Definido|
|26|**GR**|/gɾ/|Intention/Volition|✅ Definido|
|27|**PL**|/pl/|Modal/Qualitative|✅ Definido|

### 🔮 **RESERVADOS — 3 ECs Futuros**

|EC|IPA|Status|
|---|---|---|
|**BL**|/bl/|🔓 Disponível para expansão|
|**KL**|/kl/|🔓 Disponível para expansão|
|**GL**|/gl/|🔓 Disponível para expansão|
