# 🌐 Universal Ontological Language — Version 0.8.0
...
### Core Grammar
1. **[`05-grammar-cv-vc.md`](docs/05-grammar-cv-vc.md)** — CV & VC Particles (v0.7.4)
2. **[`06-basics-vcv.md`](docs/06-basics-vcv.md)** — VCV Expanded Grammar (750 particles)
3. **[`10-grammar-system.md`](docs/10-grammar-system.md)** — Verbal system and syntax

### Lexicon
4. **[`04-structure.md`](docs/04-structure.md)** — System Architecture (v0.7.0)
5. **[`09-lexicon-nominal-matrix.md`](docs/09-lexicon-nominal-matrix.md)** — Nominal Lexicon System

### Navigation & Learning
6. **[`INDEX.md`](INDEX.md)** — Complete Navigation Guide
7. **[`WELCOME.md`](community/WELCOME.md)** — Introduction for Newcomers
8. **[`LEARNING-PATH.md`](community/LEARNING-PATH.md)** — Curriculum
9. **[`FAQ.md`](community/FAQ.md)** — Frequently Asked Questions

### Project Development
10. **[`ROADMAP.md`](news/ROADMAP.md)** — Development Plan
11. **[`CHANGELOG.md`](news/CHANGELOG.md)** — Version History
...
| 12 | **J̌** | /dʒ/ | Motion | Movement pattern |
...
**Version:** 0.8.0
**Status:** Active Development — Compositional EC System
...
- 📝 [**Grammar:** VCV System](06-basics-vcv.md)
- 🔤 [**Vocabulary:** Lexicon Matrix](09-lexicon-nominal-matrix.md)
- 🏗️ [**Architecture:** Structure](04-structure.md)
